...
const I18N_MESSAGES = {
  ...
  'en': {
    ...
    hintCaptionDragResize: 'On the video: drag the caption to move it, scroll over it to resize, double-click to reset.',
...
5. If the text is already in the target language, return it EXACTLY as is (no paraphrasing or reordering)`,
  ...
  'zh-CN': {
    ...
    hintCaptionDragResize: '在视频上：拖动字幕可移动，滚轮可缩放，双击复位',
  ...
  'zh-TW': {
    ...
    hintCaptionDragResize: '在影片上：拖曳字幕可移動，滾輪可縮放，雙擊復位',
    youtubeCaptions: 'YouTube 字幕',
