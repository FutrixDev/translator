...
(globalThis.I18N_MESSAGES = globalThis.I18N_MESSAGES || {})['en'] = {
    ...
    floatMenuTranslateWholePage: 'Translate Whole Page',
    ...
    pageTranslateScopeLabel: 'Page translation scope',
    pageTranslateScopeMain: 'Main content only (recommended)',
    pageTranslateScopePage: 'Whole page',
    pageTranslateScopeHint: 'Main content only leaves the site\'s navigation, sidebars, menus, header and footer untranslated. To translate everything on one page, choose “Translate Whole Page” in the float ball menu or press Alt+W.',
...
5. If the text is already in the target language, return it unchanged (no paraphrasing or reordering)`,
    ...
    transferDesc: 'Save your settings and site rules to a file, then load them in another browser. Caches, usage statistics and your account sign-in stay on this device.',
    transferExport: 'Export Settings',
    transferImport: 'Import Settings…',
    transferIncludeApiKey: 'Include my API key',
    transferIncludeApiKeyHint: 'Off by default. Anyone with the file can use your key, so only include it in a file you keep to yourself.',
    transferPreviewTitle: 'Review before importing',
    transferConfirm: 'Import',
    transferCancel: 'Cancel',
    transferPreviewSettings: 'Settings: {changed} will change, {dropped} skipped.',
    transferPreviewChangedKeys: 'Changing: {keys}',
    ...
    transferErrorNotJson: 'This file is not valid JSON. Nothing was imported.',
    transferErrorWrongFormat: 'This is not a Blab Translation settings file. Nothing was imported.',
    transferErrorWrongVersion: 'This settings file was made by a different version of Blab Translation and cannot be read. Nothing was imported.',
    transferErrorNotObject: 'The "{section}" part of this file is damaged. Nothing was imported.',
    transferErrorNothingValid: 'Nothing in this file can be imported. No settings were changed.',
    transferErrorHotkeyConflict: 'With this file, selection translation and hover translation would share the same hotkey. Nothing was imported. Give them different keys and export again.',
    transferErrorTooLarge: 'This file is too large to be a settings file (over 1 MB). Nothing was imported.',
    transferErrorApplyFailed: 'Import stopped at {failed}: {message}. Already imported: {written}.',
    transferErrorUnexpected: 'Something went wrong: {message}',
    transferWrittenNone: 'nothing',
    transferExported: 'Settings exported',
    transferImported: 'Settings imported',

    // 首装引导页（onboarding/）
    onboardingPageTitle: 'Welcome to Blab Translation',
    onboardingIntro: 'A few quick choices and you are ready. Every change here is saved right away, and you can change it later in Settings.',
    onboardingBuiltinTitle: 'Offline translation',
    onboardingBuiltinDesc: 'Chrome can translate on this device for free, without sending your text anywhere. It needs a one-time language pack download.',
    onboardingTargetTitle: 'Translate into',
    onboardingTargetDesc: 'Translations appear in this language.',
    onboardingEngineTitle: 'Translation engine',
    onboardingEngineBuiltin: 'Built-in (recommended)',
    onboardingEngineBuiltinDesc: 'Free and private. Runs on this device.',
    onboardingEngineAi: 'Set up AI',
    onboardingEngineAiDesc: 'Use a model you choose for higher quality. Pick where it runs, then finish connecting in Settings.',
    onboardingAiOllama: 'Ollama (on this computer)',
    onboardingAiLmStudio: 'LM Studio (on this computer)',
    onboardingAiCloud: 'Cloud API (OpenAI, Claude, Gemini…)',
    onboardingAiNote: 'Settings opens in a new tab so you can pick a model and test the connection.',
    onboardingShortcutsTitle: 'Keyboard shortcuts',
    onboardingShortcutNotSet: 'Not set',
    onboardingShortcutsHint: 'To change them, type chrome://extensions/shortcuts into the address bar.',
